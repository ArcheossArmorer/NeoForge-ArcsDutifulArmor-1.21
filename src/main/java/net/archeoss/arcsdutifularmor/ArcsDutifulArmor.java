...
@Mod(ArcsDutifulArmor.MOD_ID)
public class ArcsDutifulArmor {
    ...
    @EventBusSubscriber(modid = ArcsDutifulArmor.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
